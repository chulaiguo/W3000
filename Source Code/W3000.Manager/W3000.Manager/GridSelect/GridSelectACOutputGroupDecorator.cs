...
{
	public class GridSelectACOutputGroupDecorator : GridControlDecorator
	{
		public GridSelectACOutputGroupDecorator(string userId, GridControl gridControl)
		...
		protected override void SetDisplayColumns(GridView view)
		{
			...
			colGroupID.FieldName = ACOutputGroupViewSchema.GroupID;
			...
			colSummary.FieldName = ACOutputGroupViewSchema.Summary;
			...
			colUnitID.FieldName = ACOutputGroupViewSchema.UnitID;
			...
			colAddress1.FieldName = ACOutputGroupViewSchema.Address1;
			...
			colBuildingID.FieldName = ACOutputGroupViewSchema.BuildingID;
