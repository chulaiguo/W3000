...
{
	public class GridSelectACAccessLevelDecorator : GridControlDecorator
	{
		public GridSelectACAccessLevelDecorator(string userId, GridControl gridControl)
		...
		protected override void SetDisplayColumns(GridView view)
		{
			...
			colAccessLevelID.FieldName = ACAccessLevelViewSchema.AccessLevelID;
			...
			colSummary.FieldName = ACAccessLevelViewSchema.Summary;
			...
			colAddress1.FieldName = ACAccessLevelViewSchema.Address1;
			...
			colBuildingID.FieldName = ACAccessLevelViewSchema.BuildingID;
