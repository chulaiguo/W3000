...
{
	public class GridSelectACTimecodeDecorator : GridControlDecorator
	{
		public GridSelectACTimecodeDecorator(string userId, GridControl gridControl)
		...
		protected override void SetDisplayColumns(GridView view)
		{
			...
			colTCID.FieldName = ACTimecodeViewSchema.TCID;
			...
			colSummary.FieldName = ACTimecodeViewSchema.Summary;
			...
			colAddress1.FieldName = ACTimecodeViewSchema.Address1;
			...
			colBuildingID.FieldName = ACTimecodeViewSchema.BuildingID;
