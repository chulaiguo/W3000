...
namespace W3000.HostFacadeService
{
    ...
    public partial class HostServiceInstaller : Installer
    {
        ...
        public HostServiceInstaller()
        {
            ...
            this.serviceInstaller.ServiceName = "W3000.FacadeService";
            this.serviceInstaller.DisplayName = "Workcode W3000 Facade Service";
        ...
        protected override void OnAfterInstall(System.Collections.IDictionary savedState)
        {
            ...
            string targetdir = this.Context.Parameters["targetdir"].TrimEnd('\\') + @"\FacadeService\";

            //Firewall
            string exeFile = string.Format(@"{0}\{1}", targetdir, "W3000.HostFacadeService.exe");
            if (File.Exists(exeFile))
            {
                FirewallHelper.AuthorizeProgram("W3000.FacadeService", exeFile);
            }
        }
        ...
        protected override void OnAfterUninstall(System.Collections.IDictionary savedState)
        {
            ...
            try
            {
                ...
                string exeFile = targetdir + @"\FacadeService\W3000.HostFacadeService.exe";
